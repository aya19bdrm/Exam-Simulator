...
export const FillInStyles = styled.div<FillInStylesProps>`
  position: relative;
  width: 40rem;
  padding: 1rem;
...
function FillIn({ review, fillIn, onFillIn }: FillInProps): React.JSX.Element {
...
export default React.memo(FillIn)
...
export interface FillInStylesProps extends ThemedStyles {
  focus: boolean
}
